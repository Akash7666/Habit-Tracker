...
const Day = ({day}) => {
  ...
  return (
    <div className="day-container border border-warning">
      ...
      <i className={day.isDone===false?"fa-solid fa-circle-xmark circle-icon activenot":"fa-solid fa-circle-xmark circle-icon"} onClick={notDone}></i>
      <i className={day.isDone===""?"fa-solid fa-circle-minus circle-icon activenone":"fa-solid fa-circle-minus circle-icon"} onClick={none}></i>
      <ToastContainer />
    </div>
  );
};
